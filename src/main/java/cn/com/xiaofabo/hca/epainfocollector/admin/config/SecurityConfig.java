package cn.com.xiaofabo.hca.epainfocollector.admin.config;
...
import cn.com.xiaofabo.hca.epainfocollector.admin.security.UrlSecurityInterceptor;
import cn.com.xiaofabo.hca.epainfocollector.admin.security.UserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/**/*.js", "/**/*.js.map", "/**/*.ts", "/**/*.css", "/**/*.css.map", "/**/*.png",
                "/**/*.gif", "/**/*.jpg", "/**/*.fco", "/**/*.woff", "/**/*.woff2", "/**/*.font", "/**/*.svg", "/**/*" +
                        ".ttf", "/**/*.pdf","/*.ico", "/admin/api/**", "/404", "/401","/403", "/error");
    }
